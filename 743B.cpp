...
<head>
    ...
    <meta name="X-Csrf-Token" content="56d7f8cc47ceb4a4283cfef82885af99"/>
    ...
    <meta property="og:title" content="Submission #22999592 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="0c8ae3f10150238d3ad3d1935d8e2032b8209ef9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #22999592 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='56d7f8cc47ceb4a4283cfef82885af99'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F743%2Fsubmission%2F22999592">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='56d7f8cc47ceb4a4283cfef82885af99'/>
...
<a href="/profile/John_Titor" title="Pupil John_Titor" class="rated-user user-green">John_Titor</a>    </td>
    <td>
        <a title="B - Chloe and the sequence " href="/contest/743/problem/B">743B</a>
...
#include <cmath>
using namespace std;
int fun(int n,long long k){
    if (n==1){
        return 1;
    }
    long long c=pow(2,n-1);
    if (c==k){
        return n;
    }
    else if(c>k){
