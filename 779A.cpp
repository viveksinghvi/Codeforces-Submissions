...
<head>
    ...
    <meta name="X-Csrf-Token" content="833214e5ef82f4644212d871e1c272fb"/>
    ...
    <meta property="og:title" content="Submission #28427867 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="51bf20e4ed2069b60f06b06fc60cb43e17dd6d37"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #28427867 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='833214e5ef82f4644212d871e1c272fb'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F779%2Fsubmission%2F28427867">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='833214e5ef82f4644212d871e1c272fb'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/779">Problems</a></li>
        <li><a
                                        href="/contest/779/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/779/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/779/status">Status</a></li>
        <li><a
                                        href="/contest/779/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/779/room/1">Room</a></li>
        <li><a
                                        href="/contest/779/standings">Standings</a></li>
        <li><a
                                        href="/contest/779/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/John_Titor" title="Pupil John_Titor" class="rated-user user-green">John_Titor</a>    </td>
    <td>
        <a title="A - Pupils Redistribution" href="/contest/779/problem/A">779A</a>
...
int main(){
    ...
    REP(i,1,6,1){
        if(((a[i]+b[i])/2)<a[i]){
            ans=ans-((a[i]+b[i])/2)+a[i];//            return 0;
        }
    }
    cout<<ans;
    return 0;
