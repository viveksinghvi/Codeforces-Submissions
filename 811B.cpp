...
<head>
    ...
    <meta name="X-Csrf-Token" content="ddf68d48a6b3b341d6f370c2f3d7d07c"/>
    ...
    <meta property="og:title" content="Submission #27401296 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="ff1bd360b69b8896637a841bf9fce5b6a2cf4e19"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #27401296 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ddf68d48a6b3b341d6f370c2f3d7d07c'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F811%2Fsubmission%2F27401296">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ddf68d48a6b3b341d6f370c2f3d7d07c'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/811">Problems</a></li>
        <li><a
                                        href="/contest/811/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/811/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/811/status">Status</a></li>
        <li><a
                                        href="/contest/811/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/811/room/1">Room</a></li>
        <li><a
                                        href="/contest/811/standings">Standings</a></li>
        <li><a
                                        href="/contest/811/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/John_Titor" title="Pupil John_Titor" class="rated-user user-green">John_Titor</a>    </td>
    <td>
        <a title="B - Vladik and Complicated Book" href="/contest/811/problem/B">811B</a>
    ...
    <td>2017-05-28 08:34:12</td>
    <td>2017-05-28 08:34:13</td>
    <td>
    ...
    <pre class="prettyprint lang-cpp program-source" style="padding: 0.5em;">//22 17
#include "bits/stdc++.h"
using namespace std;
...
int qs(int i,int j,int k,int b[]){
    if(i==j){
        return k;
    }
    else{
