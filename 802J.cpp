...
<head>
    ...
    <meta name="X-Csrf-Token" content="b47a38c10ead337521b2f8c003b5ed78"/>
    ...
    <meta property="og:title" content="Submission #27414566 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a3d436b7175bb0244546185ba17e45a13795d2bb"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #27414566 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b47a38c10ead337521b2f8c003b5ed78'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F802%2Fsubmission%2F27414566">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b47a38c10ead337521b2f8c003b5ed78'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/802">Problems</a></li>
        <li><a
                                        href="/contest/802/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/802/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/802/status">Status</a></li>
        <li><a
                                        href="/contest/802/standings">Standings</a></li>
        <li><a
                                        href="/contest/802/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/John_Titor" title="Pupil John_Titor" class="rated-user user-green">John_Titor</a>    </td>
    <td>
        <a title="J - Send the Fool Further! (easy)" href="/contest/802/problem/J">802J</a>
    ...
    <td>2017-05-28 17:11:47</td>
    <td>2017-05-28 17:11:48</td>
    <td>
...
using namespace std;
    ...
    int dfs(int s) {
        ...
        for(int i = 0;i < adj[s].size();++i)    {
         if(vis[adj[s][i].first] == false){
             t=adj[s][i].second+dfs(adj[s][i].first);
             if(t>a)
                a=t;
         }
        }
    ...
    int main() {
        ...
        for(int i = 0;i <e;++i) {
         cin >> x >> y>>z;
     //Undirected Graph
         adj[x].push_back(make_pair(y,z));                   //Edge from vertex x to vertex y
         adj[y].push_back(make_pair(x,z));                   //Edge from vertex y to vertex x
        }
