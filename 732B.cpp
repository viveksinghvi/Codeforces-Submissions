...
<head>
    ...
    <meta name="X-Csrf-Token" content="e84a94b36b383ffd06df59debfbeafce"/>
    ...
    <meta property="og:title" content="Submission #23501265 - Codeforces"/>
    ...
    <title>Submission #23501265 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e84a94b36b383ffd06df59debfbeafce'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F732%2Fsubmission%2F23501265">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e84a94b36b383ffd06df59debfbeafce'/>
...
int main()
{
    ...
    for (i=1;i<n;i++){
        ...
        if((v[i]+v[i-1])<r){
            c+=(r-v[i-1]-v[i]);
            //cout <<v[i]<< <<v[i-1]<< <<(r-v[i-1]-v[i])<<"gxcc"<<c<<"SFd\n";
            v[i]=r-v[i-1];
        }
    }
    cout <<c<<\n;
