...
<head>
    ...
    <meta name="X-Csrf-Token" content="ebc20e18056adf22f73f86cbfc13cb27"/>
    ...
    <meta property="og:title" content="Submission #23988359 - Codeforces"/>
    ...
    <title>Submission #23988359 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ebc20e18056adf22f73f86cbfc13cb27'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F747%2Fsubmission%2F23988359">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ebc20e18056adf22f73f86cbfc13cb27'/>
...
int main()
{
    ...
    for(int i=1;i<=q;i++){
        ...
        int ser=0,sum=0,m;
        for(m=1;m<=n;m++){
            if(f[(v[m].first)]==0 or v[m].second<j){
                v[m].second=j+l-1;
                v[m].first=i;
                ser++;
                sum+=m;
