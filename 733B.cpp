...
<head>
    ...
    <meta name="X-Csrf-Token" content="cc46c6d23fadff4386b11dc14dbc350c"/>
    ...
    <meta property="og:title" content="Submission #23925656 - Codeforces"/>
    ...
    <title>Submission #23925656 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cc46c6d23fadff4386b11dc14dbc350c'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F733%2Fsubmission%2F23925656">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cc46c6d23fadff4386b11dc14dbc350c'/>
...
int main()
{
    ...
    int ma=abs(l-r);
    for(int i=0;i<n;i++){
        if(ma<abs(l-2*v[i][0]+2*v[i][1]-r)){
            ma=abs(l-2*v[i][0]+2*v[i][1]-r);
            in=i+1;
        }
    }
    cout<<in;
