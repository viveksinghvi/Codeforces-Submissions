...
<head>
    ...
    <meta name="X-Csrf-Token" content="0da2915a2a1e9d74ade02a90dc622132"/>
    ...
    <meta property="og:title" content="Submission #27706733 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="ae0a1d330b5cbd75ad8e8b626c643de82ae0de4f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #27706733 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0da2915a2a1e9d74ade02a90dc622132'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F812%2Fsubmission%2F27706733">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0da2915a2a1e9d74ade02a90dc622132'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/812">Problems</a></li>
        <li><a
                                        href="/contest/812/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/812/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/812/status">Status</a></li>
        <li><a
                                        href="/contest/812/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/812/room/1">Room</a></li>
        <li><a
                                        href="/contest/812/standings">Standings</a></li>
        <li><a
                                        href="/contest/812/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<tr>
    ...
    <td>
            Virtual:<br/>
<a href="/profile/John_Titor" title="Pupil John_Titor" class="rated-user user-green">John_Titor</a><sup style='margin-left: 0.25em;font-size: 8px;' title="Virtual participant"><a href='/contest/812/standings/participant/12591278#p12591278'>#</a></sup>    </td>
    <td>
        <a title="A - Sagheer and Crossroads" href="/contest/812/problem/A">812A</a>
...
int main()
{
    ...
    cin.tie(NULL);
    int a[4][4];
    REP(i,0,4,1)REP(j,0,4,1)cin>>a[i][j];
    REP(i,0,4,1){
        if(a[i][3]==1){
