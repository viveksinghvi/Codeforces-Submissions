...
<head>
    ...
    <meta name="X-Csrf-Token" content="615e4181e0033a5cb044cb04f90b4a96"/>
    ...
    <meta property="og:title" content="Submission #24898399 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="cb9103baa30b3ffc2a2d0b2a5d7f53aef3ec6369"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #24898399 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='615e4181e0033a5cb044cb04f90b4a96'></span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F768%2Fsubmission%2F24898399">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='615e4181e0033a5cb044cb04f90b4a96'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/768">Problems</a></li>
        <li><a
                                        href="/contest/768/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/768/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/768/status">Status</a></li>
        <li><a
                                        href="/contest/768/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/768/room/1">Room</a></li>
        <li><a
                                        href="/contest/768/standings">Standings</a></li>
        <li><a
                                        href="/contest/768/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/John_Titor" title="Pupil John_Titor" class="rated-user user-green">John_Titor</a>    </td>
    <td>
        <a title="A - Oath of the Night's Watch" href="/contest/768/problem/A">768A</a>
...
int main(){
    ...
    cin>>n;
    int a[n];
    int l=1000000001,lc=0,h=-1,rc=0;
    for(int i=0;i<n;i++){
        cin>>a[i];
        if(a[i]==h){
            //rc=0;
